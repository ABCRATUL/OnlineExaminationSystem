  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="mypic.jpg"  alt="" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Anirban Chakraborty/a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9999</h4>
		<h4 style="font-family:'typo' ">anirbanchakraborty318@gmail.com</h4>
		<h4 style="font-family:'typo' ">Hoogly Engineering and Technology College</h4></div></div>
		</p>
      </div>
